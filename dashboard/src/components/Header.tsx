...
export function Header({showImport = false, setSessions}: HeaderProps) {
    ...
    return (
        <header
            className="sticky top-0 z-50 w-full border-b border-border bg-header-bg backdrop-blur-xl transition-colors duration-300">
            <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        <span
                            className="theme-toggle-thumb absolute top-1 bottom-1 rounded-full transition-all duration-300 shadow-sm"/>

                        <span
                            className="theme-toggle-moon relative z-10 flex items-center justify-center w-1/2 transition-colors duration-300">
                            <Moon size={13} strokeWidth={2}/>
                        </span>

                        <span
                            className="theme-toggle-sun relative z-10 flex items-center justify-center w-1/2 transition-colors duration-300">
