...
/** Formats milliseconds as a zero-padded `MM:SS.mmm` duration. */
...
/** Returns a solve's penalty-adjusted milliseconds, or `null` for a DNF. */
...
/** Formats a solve with its `+2` or DNF marker. */
...
/** Computes a WCA-trimmed mean from exactly `n` effective times. */
...
/** Returns the fastest successful solve in a session. */
...
/** Returns the arithmetic mean of successful solves. */
...
/** Returns the slowest successful solve in a session. */
...
/** Returns the population standard deviation of successful solve times. */
...
/** Counts solves carrying a particular penalty modifier. */
...
/** Returns the percentage of attempts that are not DNFs. */
...
/** Returns elapsed wall-clock time between the first and last timestamped solve. */
...
/** Ranks the latest valid solve by the percentage of session solves it beat. */
...
/** Groups successful solve times into evenly sized histogram buckets. */
...
/** Formats a long duration in hours and minutes. */
...
/** Formats a Unix millisecond timestamp as a short localized date. */
...
/** Formats an optional or DNF statistic for display. */
